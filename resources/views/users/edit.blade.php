                        ...
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="username" id="input-name" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Benutzername') }}" value="{{ old('username', $user->username) }}"  required autofocus autocomplete="off">

                                    @include('alerts.feedback', ['field' => 'username'])
                                </div>
                                <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('Vorname') }}</label>
                                    <input type="text" name="firstname" id="input-name" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" placeholder="{{ __('Vorname') }}" value="{{ old('firstname', $user->firstname) }}"  required autocomplete="off">

                                    @include('alerts.feedback', ['field' => 'firstname'])
                                </div>
                                <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('Nachname') }}</label>
                                    <input type="text" name="surname" id="input-name" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" placeholder="{{ __('Nachname') }}" value="{{ old('surname', $user->surname) }}"  required autocomplete="off">

                                    @include('alerts.feedback', ['field' => 'surname'])
                                </div>
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-email">{{ __('E-Mail-Adresse') }}</label>
                                    <input type="email" name="email" id="input-email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('E-Mail-Adresse') }}" value="{{ old('email', $user->email) }}" required autocomplete="off">
