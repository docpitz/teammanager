                        ...
                        <form method="post" action="{{ route('event.update', $event) }}" autocomplete="off"
                            ...
                            <div class="pl-lg-6">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea rows="3" name="description" id="input-description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Beschreibung') }}" value="{{ old('description', $event->description) }}"></textarea>
